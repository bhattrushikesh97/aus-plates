...
class Widget_z_main_call_to_action extends Widget_Base {

    public function get_name() {
        return 'adforest_main_call_to_action';
    }

    public function get_title() {
        return __('Main Section - Call To Action','adforest-elementor');
    }
    ...
    protected function render() {
        ...
        $adforest_render_params['section_img'] = isset($package_settings_fields['section_img']['id']) ? $package_settings_fields['section_img']['id'] : '';
         ...
         echo adforest_maincallt_shortcode_func($adforest_render_params);
