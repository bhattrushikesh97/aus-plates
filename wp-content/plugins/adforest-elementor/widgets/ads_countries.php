...
class Widget_ads_countries extends Widget_Base {

    public function get_name() {
        return 'location_short_base';
    }

    public function get_title() {
        return __('Custom Locations Slider', 'adforest-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $repeater_country->add_control(
                ...
                [
                    ...
                    "description" => __("Recommended size 270x283", 'adforest-elementor'),
                    'default' => [
    ...
    protected function render() {
        ...
        $params['select_locations'] = isset($atts['select_locations']) ? $atts['select_locations'] : "";
          ...
          if(function_exists('location_short_modern_base_func')){
              echo   location_short_modern_base_func($params);      
