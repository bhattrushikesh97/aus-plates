...
class Widget_ads_slider_modern extends Widget_Base {

    public function get_name() {
        return 'ads_short_slider_base';
    }
    ...
    protected function render() {
        ...
        $adforest_render_params['section_title'] = isset($ads_slider_settings_fields['section_title']) ? $ads_slider_settings_fields['section_title']:'';
        ...
        $adforest_render_params['section_description'] = isset($ads_slider_settings_fields['section_description']) ? $ads_slider_settings_fields['section_description']:'';
        // ads settings
        ...
        $adforest_render_params['section_tagline'] = isset( $ads_slider_settings_fields['section_tagline']) ? $ads_slider_settings_fields['section_tagline']:'';


if(function_exists('ads_short_slider_base_func')){
        
        echo ads_short_slider_base_func($adforest_render_params);
