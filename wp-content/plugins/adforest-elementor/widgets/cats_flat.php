...
class Widget_cats_flat extends Widget_Base {

    public function get_name() {
        return 'cats_flat_short_base';
    }

    public function get_title() {
        return __('Categories - Flat','adforest-elementor');
    }
   ...
   protected function register_controls() {
    ...
    protected function render() {
        ...
        echo cats_flat_short_base_func($adforest_render_params);
    }
}