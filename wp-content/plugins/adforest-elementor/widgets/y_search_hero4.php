...
class Widget_y_search_hero4 extends Widget_Base {

    public function get_name() {
        return 'search_hero4_short_base';
    }

    public function get_title() {
        return __('Search - Hero 4','adforest-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            "description" => __("1920x750", 'adforest-elementor'),
            'default' => [
    ...
    protected function render() {
        ...
        echo search_hero4_short_base_func($adforest_render_params);
    }
