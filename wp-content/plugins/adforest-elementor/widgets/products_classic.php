...
class Widget_products_classic extends Widget_Base {

    public function get_name() {
        return 'price_classic_short_base';
    }

    public function get_title() {
        return __('Products - Classic','adforest-elementor');
    }
    ...
    protected function render() {
        ...
        echo price_classic_short_base_func($adforest_render_params);
