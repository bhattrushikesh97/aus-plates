...
class Widget_process_cycle2 extends Widget_Base {

    public function get_name() {
        return 'process_cycle_short_base2';
    }

    public function get_title() {
        return __('Process Cycle 2', 'adforest-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                's1_icon', [
            'label' => __('Icon / put flaticon', 'adforest-elementor'),
            'type' => Controls_Manager::TEXT,
            'default' => '',
    ...
    protected function render() {
        ...
        echo process_cycle2_short_base_func($params);
    }
