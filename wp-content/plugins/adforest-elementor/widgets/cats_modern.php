...
class Widget_cats_modern extends Widget_Base {

    public function get_name() {
        return 'cats_modren_short_base';
    }

    public function get_title() {
        return __('Categories - Modern','adforest-elementor');
    }
    ...
    protected function render() {
        ...
        echo cats_modren_short_base_func($adforest_render_params);
    }
}