...
class Widget_products_minimal extends Widget_Base {

    public function get_name() {
        return 'price_minimal_short_base';
    }

    public function get_title() {
        return __('Products - Minimal','adforest-elementor');
    }
    ...
    protected function render() {
        ...
        echo price_minimal_short_base_func($adforest_render_params);
