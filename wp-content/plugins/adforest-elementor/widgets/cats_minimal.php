...
class Widget_cats_minimal extends Widget_Base {

    public function get_name() {
        return 'cats_minimal_short_base';
    }

    public function get_title() {
        return __('Categories - Minimal','adforest-elementor');
    }
    ...
    protected function render() {
        ...
        echo cats_minimal_short_base_func($adforest_render_params);
    }
}