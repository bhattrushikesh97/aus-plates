...
class Widget_ads_cats_boxes extends Widget_Base {

    public function get_name() {
        return 'ads_cats_boxes_short_base';
    }

    public function get_title() {
        return __('ADs - with Cats boxes','adforest-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $catbox_repeator = new \Elementor\Repeater();

        $catbox_repeator->add_control(
                'cat', array(
        ...
        $this->add_control(
            'cats_box',
            [
                'label' => __( 'Add Categories','adforest-elementor' ),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $catbox_repeator->get_controls(),
                'default' => [],
                'title_field' => '{{{ cat }}}',
			]
        );
    ...
    protected function render() {
        ...
        //cats
        $adforest_render_params['cats'] = isset($ads_settings_fields['cats_box']) ? $ads_settings_fields['cats_box'] :'';


         if(function_exists('ads_cats_boxes_short_base_func')){

        echo ads_cats_boxes_short_base_func($adforest_render_params);
