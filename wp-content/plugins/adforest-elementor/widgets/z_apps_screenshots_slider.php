...
class Widget_z_apps_screenshots_slider extends Widget_Base {

    public function get_name() {
        return 'apps_screenshots_slider';
    }

    public function get_title() {
        return __('Apps Screenshots - Slider','adforest-elementor');
    }
    ...
    protected function register_controls() {
      ...
      $repeater->add_control(
                'title', [
            'label' => __('Screenshot Name','adforest-elementor'),
    ...
    protected function render() {
        ...
        echo apps_screenshots_slider_func($adforest_render_params);
