                ...
                <div class="best-car-sale">
                    <div class="sale-head">
                        ...
                        <?php if(isset($adforest_theme['sb_show_ad_id']) && $adforest_theme['sb_show_ad_id'] ){
                           ?>
                            <p class="sb_ad_id"> ID :  <?php echo $pid; ?> </p>
                       <?php  }
                       ?>
                        ...
                        <ul class="clendar-head">
                            <li><a href="javascript:void(0)" class="update-item" alt="<?php echo esc_attr__('void', 'adforest'); ?>"><i class="fa fa-calendar"></i> <?php echo get_the_date(); ?></a></li>
                            <li><a href="javascript:void(0)" class="update-item" alt="<?php echo esc_attr__('void', 'adforest'); ?>"> <?php echo esc_html__('Views:', 'adforest') ?><span><?php
                    ...
                    <div class="offer-heading">
                        ...
                        if ($price_type == "no_price") {
                            ...
                            echo '<span>' . adforest_adPrice($pid, 'negotiable-single') . '</span>';
                        }
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="list-feature">
                    <ul class="listning-list-all">
                        <li><a href="#"><?php echo esc_html__('Features', 'adforest') ?></a></li>
                        <li><a href="#descrip-head"><?php echo esc_html__('Description', 'adforest') ?></a></li>
                        <?php if (get_post_meta($pid, '_adforest_ad_location', true) != "") { ?>
                            <li><a href="#map-location"><?php echo esc_html__('Location', 'adforest') ?></a></li>
                        <?php } if (get_post_meta($pid, '_adforest_ad_yvideo', true) != "") { ?>
                            <li><a id="play-video" href="<?php echo get_post_meta($pid, '_adforest_ad_yvideo', true); ?>"><?php echo esc_html__('Video', 'adforest') ?></a></li>
                        <?php } if (isset($adforest_theme['sb_enable_comments_offer']) && $adforest_theme['sb_enable_comments_offer'] && $ad_status != 'sold' && $ad_status != 'expired' && get_post_meta($pid, '_adforest_ad_price', true) != "0") { ?>
                            <li><a href="#all-bids-comment"><?php echo esc_html__('Bids', 'adforest') ?></a></li>
                        <?php } ?>
                        <li><a href="#ad-rating"><?php echo esc_html__('Reviews', 'adforest') ?></a></li>                       
                        <li><a href="#related-ads-container"><?php echo esc_html__('Related Ads', 'adforest') ?></a></li>
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="descrip-head" id="descrip-head">
                    <div class ="style1-short-features">
                        <h3 class='heading'><?php echo esc_html__('Description', 'adforest') ?></h3>
                        <?php get_template_part('template-parts/layouts/ad-style/short', 'features'); ?>
                    </div>

                    <?php get_template_part('template-parts/layouts/ad-style/desc', 'box'); ?>
                    ...
                    <div class="cont-list-detail">
                        ...
                        <?php if (get_post_meta($pid, '_adforest_ad_type', true) != "") { ?>
                            <div class="ad-type">
                                ...
                                <div class="sell-content">
                                    <img src="<?php echo esc_url($link1); ?>" alt="<?php echo esc_html__('ad type', 'adforest'); ?>"> <span class="ad-type-text"><?php echo adforest_returnEcho($ad_type_val); ?></span>
                                    <span class="sell-icon"><img src="<?php echo esc_url($link2); ?>" alt="<?php echo esc_html__('ad type', 'adforest'); ?>"></span>
                                </div>                           
                            </div>                     
                            <?php
                        }
                        ...
                        if ($adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'phone') {
                            ...
                            if ($contact_num != "") {
                                ...
                                if (adforest_showPhone_to_users()) {
                                    ...
                                    ?>
                                    <div class="details-click-view phone"><a data-ad-id="<?php echo intval($pid); ?>"  href="<?php echo adforest_returnEcho($call_now); ?>" class="sb-click-num2" id="show_ph_div"><span class="info-heading"><i class="fa fa-phone"></i><?php echo esc_html__('Phone :', 'adforest') ?></span><span class="sb-phonenumber"><?php echo esc_html__('Login to view', 'adforest'); ?></span><?php if ($batch_text != "") { ?><small class="sb-small">-<?php echo adforest_returnEcho($batch_text); ?></small><?php } ?></a></div>

                                <?php } else { ?>

                                    <div class="details-click-view phone"><a data-ad-id="<?php echo intval($pid); ?>"  href="<?php echo adforest_returnEcho($call_now); ?>" class="sb-click-num" id="show_ph_div"><span class="info-heading"><i class="fa fa-phone"></i><?php echo esc_html__('Phone :', 'adforest') ?></span><span class="sb-phonenumber"><?php echo esc_html__('Click to view', 'adforest'); ?></span><?php if ($batch_text != "") { ?><small class="sb-small">-<?php echo adforest_returnEcho($batch_text); ?></small><?php } ?></a></div>
                        ...
                        <div class="detail-msg">
                            ...
                            if ($allow_whatsapp && $contact_num != "") {
                                ...
                                ?>
                                <a  href="<?php echo esc_url($redirect_url) ?>" class="btn btn-whatsap" target = "_blank">
                            ...
                            if ($allow_whizchat) {
                                ?>
                                <a  href="javascript:void(0)" class="btn btn-whizchat chat_toggler"  data-page_id="<?php echo esc_attr(get_the_ID()); ?>"   data-user_id ="<?php echo esc_attr($poster_id) ?>">
                            ...
                            if (get_current_user_id() == "" || get_current_user_id() == 0) {
                                ...
                                <div class="contact-message">
                                    <form id="send_message_pop" method="post">
                                        ...
                                        <div class="form-group">
                                            <textarea id="sb_forest_message" name="message" placeholder="<?php echo __('Type here...', 'adforest'); ?>" rows="8" class="form-control" data-parsley-required="true" data-parsley-error-message="<?php echo __('This field is required.', 'adforest'); ?>"></textarea>
                                        </div>
