...
<?php
$layout = 'list_1';
if (isset($adforest_theme['search_layout_types_list']) && $adforest_theme['search_layout_types_list'] != "") {
    $layout = $adforest_theme['search_layout_types_list'];
}
