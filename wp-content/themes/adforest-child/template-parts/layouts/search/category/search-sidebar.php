            ...
            <div class="col-xxl-10 col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 col-pm">
                ...
                <?php if (isset($term_id) && $term_id != "") { ?>
                    ...
                    $show = true;
                        ...
                        if((is_array($ad_cats) && !empty($ad_cats)) ||  ( $cat_term_desc != "" && $adforest_theme['display_cat_desc'] ) ){
                        ...
                        foreach ($ad_cats as $ad_cat) {
                            ...
                            if ($rows_count > $max_rows && $show) {
                                $show = false;
                                $res .= '<li class="col-md-12 col-sm-12 col-xs-12 hide_cats text-end margin-top-20"><a href="javascript:void(0);"  class="tax-show-more">' . __('Show more', 'adforest') . '</a></li>';
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            echo  '<div id="cat-full-text" style="display: none;">' . $cat_term_desc . '
 <a href="javascript:void(0)" id="show_less">' . esc_html__('Read Less', 'adforest') . '</a></div>';


                               echo   $cat_term_des  = '<div id="cat-half-text">'.wp_trim_words($cat_term_desc ,15)             .'<a href="javascript:void(0)" id ="show_more"> '.esc_html__('Read More','adforest').'</a></div>';
                ...
                <div class="search-found-list"> 
                    <div class="row">
                        ...
                        if ($results->have_posts()) {
                            ...
                            $layout_type = isset($adforest_theme['texonomy_single_style']) ?
                                    $adforest_theme['texonomy_single_style'] : "grid_1";
