                        ...
                        <ul class="list-inline sb-spt-links">
                            ...
                            if (is_user_logged_in()) {
                                ...
                                if (isset($adforest_theme['communication_mode']) && ( $adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'message' )) {
                                    ?><li><a href="<?php echo get_the_permalink($sb_notification_page); ?>"><i class="fa fa-envelope"></i><div class="sb-notify"> <?php
                                    global $wpdb;
                                    $unread_msgs = ADFOREST_MESSAGE_COUNT;
                                    if ($unread_msgs > 0) {
                                        $msg_count = $unread_msgs;
                                        ?><span class="sb-heartbit"></span><span class="point"></span></div><?php } ?></a></li><?php
                                            }
...
<div class="sb-header header-transparent <?php echo esc_attr($is_sticky_header); ?> sb-header-10  header-transparent-on <?php
        ...
        <div class="sb-header-container">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <!--Navigation menu-->      
                    <nav class="sb-menu menu-caret submenu-top-border submenu-scale mega-menu menu-10  <?php echo esc_html($menu_class) ?>">
