...
?>
<div class="sb-header header-transparent  sb-header-8 header-transparent-on <?php echo esc_attr($header_ext_class);
        ...
        <div class="sb-header-container">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <!--Navigation menu-->      
                    <nav class="sb-menu menu-caret submenu-top-border submenu-scale mega-menu menu-8  <?php echo esc_html($menu_class) ?>">
