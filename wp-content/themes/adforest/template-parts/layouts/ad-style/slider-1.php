<!-- Place somewhere in the <body> of your page -->
 <?php wp_enqueue_script('adforest-fancybox'); 
     ...
     $is_thumbnail   =  isset($adforest_theme['ad_slider_type'])  ?  $adforest_theme['ad_slider_type'] : "1";
  ...
  <ul class="slides">
   <?php
        ...
        if (count($media) > 0) {
            ...
            <li class=""><div><a href="<?php echo esc_url($img);?>" data-caption="<?php echo esc_attr($title);?>" data-fancybox="group"><img alt="<?php echo esc_attr($title);?>" src="<?php echo esc_url($img);?>"></a></div></li>
        <?php  }
      }
