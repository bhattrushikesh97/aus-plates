                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
                                <div class="upgrade-position-detail">
                                    ...
                                    <h6><?php echo esc_html__('What is Bump Up Ad?','adforest'); ?></h6>
                                    <ul>
                                        <li>
                                            <img src="<?php echo get_template_directory_uri()."/images/tick-img.png" ?>" alt="tick-icon">
                                             <?php echo esc_html__('Get noticed with','adforest'); ?><span><?php echo esc_html__('"Bump up"','adforest'); ?></span><?php echo esc_html__('tag in top position','adforest'); ?> 
                                        </li>
                                        <li>
                                            <img src="<?php echo get_template_directory_uri()."/images/tick-img.png" ?>" alt="tick-icon">
