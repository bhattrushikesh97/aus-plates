        ...
        <div class="container">
            <div class="row">
                ...
                <div class="<?php echo esc_attr($blog_type); ?>">
                    <?php 
                        if(isset($adforest_theme['blog_advertisment_top']) &&   $adforest_theme['blog_advertisment_top'] != ""){
                    ...
                    <div class="row posts-masonry">      
                       ...
                       <?php 
                        if(isset($adforest_theme['blog_advertisment_bottom']) &&   $adforest_theme['blog_advertisment_bottom'] != ""){
                           echo $adforest_theme['blog_advertisment_bottom'];
                                 }
                             ?>
                </div>
