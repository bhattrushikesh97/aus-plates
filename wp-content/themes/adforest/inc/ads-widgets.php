    ...
    class adforest_radius_search_locations extends WP_Widget {
        ...
        public function form($instance) {
            ...
            <label for="<?php echo esc_attr($this->get_field_id('default_value')); ?>" >
                ...
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('default_value')); ?>" name="<?php echo esc_attr($this->get_field_name('default_value')); ?>" type="number" value="<?php echo esc_attr($default_value); ?>">
           
                <label for="<?php echo esc_attr($this->get_field_id('edit_able')); ?>" >
                    <?php echo esc_html__('Editable:', 'adforest'); ?>
                </label> 
                <select name="<?php echo esc_attr($this->get_field_name('edit_able')); ?>" id="<?php echo esc_attr($this->get_field_id('edit_able')); ?>"  class="widefat">
                    <option value="yes" <?php if(isset($edit_able) && $edit_able == 'yes') echo 'selected'; ?> >Yes</option>
                ...
                <select name="<?php echo esc_attr($this->get_field_name('show_hide')); ?>" id="<?php echo esc_attr($this->get_field_id('show_hide')); ?>"  class="widefat">
                    <option value="show" <?php if(isset($show_hide) && $show_hide == 'show') echo 'selected'; ?> >Show</option>
                    <option value="hide" <?php if(isset($show_hide) && $show_hide == 'hide')  echo 'selected';?>>Hide</option>
                </select>
