...
/* Search Modern */
/* ------------------------------------------------ */
if (!function_exists('ads_listshort')) {
    function ads_listshort() {
        $cat_array = array();
        $cat_array = apply_filters('adforest_ajax_load_categories', $cat_array, 'cat', 'yes');
        vc_map(array(
            "name" => __("Ads list", 'adforest'),
            "base" => "ads_listshort_base",
...
add_action('vc_before_init', 'ads_listshort');
if (!function_exists('ads_listshort_base_func')) {

    function ads_listshort_base_func($atts, $content = '') {
        ...
        $category = '';
        if (isset($cats_arr) && !empty($cats_arr) && count($cats_arr) > 0) {
    ...
    global $adforest_theme;
            ...
            if ($results->have_posts()) {     
                    ...
                    while ($results->have_posts()) {
                        ...
                        $list_html .= adforest_search_layout_list($pid);                        
                    }
                    wp_reset_postdata();
                } 
         ...
         return  '<section class="custom-padding  pistachio-classified-grid  '.$section_bg.'">
                        <div class="container">
...
if (function_exists('adforest_add_code')) {
    adforest_add_code('ads_listshort_base', 'ads_listshort_base_func');
}