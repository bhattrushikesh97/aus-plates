...
if (!function_exists('shop_layout_modern_short')) {
    ...
    function shop_layout_modern_short() {
        vc_map(array(
            "name" => __("Shop Layout - Modern 1", 'adforest'),
    ...
    function shop_layout_modern_short_base_func($atts, $content = '') {
        ...
        if ($product_loop->have_posts()) {
            while ($product_loop->have_posts()) {
                ...
                $html .= '<div class="col-sm-6 col-lg-' . esc_attr($p_cols) . ' col-md-6">
        ...
        return '<section class="custom-padding shop-layout-1 ' . $parallex . ' ' . $bg_color . '" ' . $style . '>
            <div class="container">
