...
/* ADs Listing - Service */
/* ------------------------------------------------ */
if (!function_exists('adforest_ads_listing_grid_short_new')) {

    function adforest_ads_listing_grid_short_new() {
            ...
            $grid_array = array(
                ...
                __('Grid 11', 'adforest') => 'grid_10',
                __('Grid 15', 'adforest') => 'grid_15',
            );
        ...
        vc_map(array(
            "name" => __("ADs Listing 2 with sidebar - Service", 'adforest'),
            "description" => '',
            "base" => "adforest_ads_listing_grid_new",
...
add_action('vc_before_init', 'adforest_ads_listing_grid_short_new');
...
if (function_exists('adforest_add_code')) {
    adforest_add_code('adforest_ads_listing_grid_new', 'adforest_ads_listing_grid_callback_new');
}
