    ...
    function shop_layout_modern_short3_base_func($atts, $content = '') {
        ...
        if ($product_loop->have_posts()) {
            while ($product_loop->have_posts()) {
                ...
                $shop_thumb = '<a href="' . esc_url(get_the_permalink($product_id)) . '"><img class="img-fluid" alt="' . get_the_title($product_id) . '" src="' . esc_url(wc_placeholder_img_src('adforest-shop-home')) . '"></a>';
                ...
                $html .= '<div class="col-sm-6 col-xs-12 col-lg-' . esc_attr($p_cols) . ' col-md-6">
