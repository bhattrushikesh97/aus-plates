...
if (!function_exists('price_minimal_short_base_func')) {
    ...
    function price_minimal_short_base_func($atts, $content = '') {
            ...
            foreach ($rows as $row) {
                ...
                if (isset($prod_id)) {
                 ...
                 if (get_post_meta($prod_id, 'package_make_bidding_paid', true) != "") {
                        ...
                        $inner_html .= '<span class="f_custom">' . __('Paid Bidding ', 'adforest') . ': ' . $package_make_bidding_paid . '</span>';
                    }
                    ...
                    $html .= '<div class="col-lg-4 col-xl-4 col-sm-12 col-md-6 col-xs-12">
        ...
        return $scrtpt . ' <section class="custom-padding pg-minimal ' . $parallex . ' ' . $bg_color . '" ' . $style . '>
            <div class="container">
               <div class="row">
			   ' . $header . '
