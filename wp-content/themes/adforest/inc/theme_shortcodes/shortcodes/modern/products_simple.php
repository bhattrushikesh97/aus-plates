            ...
            foreach ($rows as $row) {
                ...
                if (isset($prod_id)) {
                    ...
                    if (get_post_meta($prod_id, 'package_allow_bidding', true) != "") {
                        ...
                        $inner_html .= '<span class="time">' . __('Paid biddings ', 'adforest') . ': ' . $package_allow_bidding . '</span>';
                    }
                  ...
                  if (get_post_meta($prod_id, 'package_make_bidding_paid', true) != "") {
                        ...
                        $inner_html .= '<span class="time">' . __('Allow Bidding ', 'adforest') . ': ' . $package_make_bidding_paid . '</span>';
                    }
