...
if (!function_exists('search_hero4_short_base_func')) {
  ...
  extract(shortcode_atts(array(
        ...
        if ($bg_img != "") {
            ...
            $style = ( $bgImageURL != "" ) ? ' style="background: url(' . $bgImageURL . '); height: 750px;background-repeat: no-repeat;background-size: cover; background-position: center;width: 100%;position: relative;padding: 230px 0;"' : "";
        }
        $location_type_html = '';
        $contries_script = '';
        ...
        return $contries_script . '<section class="background-section sugar-hero" ' . $style . '>
  <div class="container">
  <form action="' . urldecode(get_the_permalink($sb_search_page)) . '">
    <div class="col-lg-12 col-xs-12 col-md-12">
      ...
      <div class="col-lg-12 offset-lg-1 col-xs-12 col-md-12 col-md-offset-1 col-sm-12">
      <div class="row">
        <div class="col-lg-3  col-xl-3  col-xxl-3  col-12 col-md-3 col-sm-12 col-pm">
          <div class="row">
        ...
        <div class="col-lg-2 col-xl-3  col-xxl-3  col-12 col-md-2 col-sm-12 no-padding col-pm">
          <div class="new-featured-list-2">
            <button class="btn btn-theme" type="submit">' . __('Search', 'adforest') . '</button>
          </div>
        </div>
        </div>
      </div>
