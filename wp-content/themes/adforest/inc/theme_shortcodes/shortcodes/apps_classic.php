...
if (!function_exists('app_classic_short_base_func')) {
    ...
    function app_classic_short_base_func($atts, $content = '') {
        ...
        $apps = '';
        if ($a_link != "") {
            $apps .= '<div class="col-md-12 col-lg-6" >
        ...
        if (isset($adforest_elementor)) {
            if (isset($app_img['url']) && $app_img['url'] != "") {
                $img_html = '<div class="mobile-image-content">
    <img src="' . ($app_img['url']) . '" alt="' . __('app image', 'adforest') . '">
    </div>';
            }
        } else {
            $img_html = '';
	...
	<img src="' . adforest_returnImgSrc($app_img) . '" alt="' . __('app image', 'adforest') . '">
        ...
        if ($bg_img != "") {
           ...
           if($section_title != ""){
                $section_heading   =  '<h3>' . esc_html($section_title) . '</h3>';

           }
          

        return '<div class="app-download-section app-download-pistachio style-2"  ' . $style . '>
