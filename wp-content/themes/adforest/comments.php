...
<div class="blog-section">
    ...
    $comment_args = array(
        ...
        'fields' => apply_filters('comment_form_default_fields', array(
            ...
            'author' => '<div class="row"><div class="col-sm-4"><div class="form-group"><label for="author">'
            ...
            '<input type="text" required placeholder="' . esc_html__('Your URL Please', 'adforest') . '" id="url" class="form-control" name="url" size="30"' . "" . ' /></div></div></div> <!-- End col-sm-6 -->',
        )),
