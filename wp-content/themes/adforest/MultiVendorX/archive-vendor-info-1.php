...
$template_class = get_mvx_vendor_settings('mvx_vendor_shop_template_options', 'vendor', 'dashboard', 'template1');
...
if(isset($_GET['template_type']) && $_GET['template_class']){
